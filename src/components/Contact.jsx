...
export default function Contact() {
  ...
  return (
    <>
    <NavBar/>
    <div className=" bg-east-bay-800 px-6 py-24 sm:py-32 lg:px-8 ">
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Hablemos</h2>
        <p className="mt-2 text-lg leading-8 text-white">
          Espero tu mensaje para que podamos ponernos en contacto!
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Switch.Label className="text-sm leading-6  text-white">
              Seleccionando aquí, aceptas nuestras{' '}
